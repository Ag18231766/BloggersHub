                ...
                <div className="mt-4">
                  <div>
                    ...
                    <div className="text-left">
                      <input className="w-full" placeholder="email .." onChange={(e) => SetSignInInputs((t) => ({...t,email:e.target.value}))}></input>
                    </div>
                  </div>
                </div>
                <div className="mt-4">
                  <div>
                    ...
                    <div className="text-left">
                      <input className="w-full" placeholder="email .." onChange={(e) => SetSignInInputs((t) => ({...t,password:e.target.value}))}></input>
                    </div>
                  </div>
                </div>
                <div>
